...
import { uploadW4FormExample } from "../../../../redux/feature/adminW4Form/W4FprmExampleSlice";

const AdminW4FormExample = () => {
  // upload file states
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await dispatch(uploadW4FormExample(formData));
    if (uploadW4FormExample.fulfilled.match(result)) {
      setLoading(false);
    }
    toast.success("W4 example Form  submitted successfully 🍾");
    setUploadedFiles("");
  };
  ...
  return (
    <div className="">
      ...
      <p className="text-white text-3xl font-semibold text-center mb-14">
        CBYRAC, Inc 2025 W4 form example
      </p>
...
export default AdminW4FormExample;

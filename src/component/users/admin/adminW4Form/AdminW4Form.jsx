...
import { uploadW4Form } from "../../../../redux/feature/adminW4Form/W4FormSlice";
...
const Adminw4Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await dispatch(uploadW4Form(formData));
    if (uploadW4Form.fulfilled.match(result)) {
      setLoading(false);
    }

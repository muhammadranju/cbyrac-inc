...
import { uploadI9FormExample } from "../../../../redux/feature/adminI9Form/adminI9ExampleForm";
const AdminI9FormExample = () => {
  // upload file states
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await dispatch(uploadI9FormExample(formData));
    if (uploadI9FormExample.fulfilled.match(result)) {
      setLoading(false);
    }
    toast.success("I9 Example Form submitted successfully 🍾");
    setUploadedFiles("");
  };
  ...
  return (
    <div className="">
      ...
      <p className="text-white text-3xl font-semibold text-center mb-14">
        CBYRAC, Inc 2025 I9 form example
      </p>
...
export default AdminI9FormExample;

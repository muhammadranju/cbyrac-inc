...
import { uploadI9Form } from "../../../../redux/feature/adminI9Form/adminI9FormSlice";
...
const AdminI9Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await dispatch(uploadI9Form(formData));
    if (uploadI9Form.fulfilled.match(result)) {
      setLoading(false);
    }

          ...
          <form className="rounded-2xl max-w-7xl mx-auto">
            ...
            <div className="mb-6">
              <label className="flex items-start gap-2">
                <input
                  type="checkbox"
                  {...register("applicantCarification.check", {
                ...
                />
                <span>
                  In signing below, I acknowledge that I have read and
                  understand all the terms of this Application for Employment.
                </span>
              </label>
              {errors.applicantCarification?.check && (
                <p className="text-red-500 text-sm mt-2">
                  {errors.applicantCarification.check.message}
                </p>
              )}
            </div>

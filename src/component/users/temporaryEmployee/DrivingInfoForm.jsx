...
const DrivingInfoForm = ({ prevStep, nextStep, step, setFormData }) => {
  const totalSteps = 11;
  ...
  const nextStepHandler = async () => {
    ...
    if (result) {
      ...
      setFormData((prev) => {
        ...
        const licenseSuspended = allData.licenseSuspended || "No";
        const hasAutoInsurance = allData.hasAutoInsurance || "No";
        const insuranceDenied = allData.insuranceDenied || "No";

        // Build structured data
        const drivingLicenceInfo = {
          validDriverLicense: {
            ...
            reason:
              hasValidLicense === "No" ? allData.noLicenseReason || "" : "",
          },
          ...
          movingTrafficViolation: [
            {
              offense: allData.violationOffense1 || "",
              date: allData.violationDate1 || "",
              location: allData.violationLocation1 || "",
              comment: allData.violationComments1 || "",
            },
            {
              offense: allData.violationOffense2 || "",
              date: allData.violationDate2 || "",
              location: allData.violationLocation2 || "",
              comment: allData.violationComments2 || "",
            },
            {
              offense: allData.violationOffense3 || "",
              date: allData.violationDate3 || "",
              location: allData.violationLocation3 || "",
              comment: allData.violationComments3 || "",
            },
            {
              offense: allData.violationOffense4 || "",
              date: allData.violationDate4 || "",
              location: allData.violationLocation4 || "",
              comment: allData.violationComments4 || "",
            },
          ].filter((v) => v.offense || v.date || v.location || v.comment),
        };

        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-9">
            ...
            <p>
              ...
              will be placed in their medical file for future reference in case
              of problems.
            </p>
            <p>
              2. The supervisor must complete a Supervisor’s Reports of
              Accident, i.e. the person you report to on your assignment, at the
              same time the employee accident report is being filled out,
              regardless of whether medical attention is required. Both reports
              need to be faxed to CBYRAC, INC office at (786)403-5043.
            </p>
            <p>
              3. If the injury requires medical attention and is not an
              emergency situation, have your supervisor call (786)403-5043 prior
              to going to a medical facility. In case of an emergency, have your
              supervisor call and report which medical facility you are being
              transported to. We need to authorize treatment, arrange for proper
              billing, and determine that the facility follows proper
              procedures.
            </p>
            <p>
              ...
              advise CBYRAC, INC office of their status. Upon receiving a
              release to return to work, you must call the office to report your
              availability.
            </p>
            <p>
              5. Anytime an employee is on light duty the doctor’s restrictions
              must be followed. The employee may return to his/her regular
              duties only when release in writing by the doctor. It is your
              responsibility to tell the doctor that CBYRAC, INC has all types
              of light duty work.
            </p>
            <p>
            ...
            <p>
              7. I understand and agree to abide by the above accident
              procedures. I understand that any payments made to me or to anyone
              else for expenses in connection with my accident and resulting
              injury is not an admission of liability on the part CBYRAC, INC.
              In the event of an injury, I authorize full access to copies of
              medical records, radiology reports, drug/alcohol screenings and
              documents of any kind relating to my past or present
              injury/illness to CBYRAC, INC.I hereby agree to release this
              information and Hold all such medical providers harmless from the

...
import { submitEmployeeForm } from "../../../redux/feature/Internemployee/internSlice";
      ...
      if (step === 1) {
        setFormData((prev) => ({
          ...
          generalInfo: {
            ...
            previouslyApplied: allData.previousApplication,
            previousApplicationDate: allData.applicationDetails,
            previouslyEmployed: allData.previousEmployment,
